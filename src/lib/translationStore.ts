...
export const translations = {
  en: {
    ...
    embrace_elegance: "Saudi Arabia's Favorite Modest Fashion Collection 🇸🇦",
    hero_description: "Premium Terno Sets, Abayas & Daily Wear",
    hero_bullet_1: "🔥 Up to 40% OFF",
    hero_bullet_2: "🚚 Cash on Delivery Available",
    hero_bullet_3: "⭐ 1000+ Happy Customers",
    ...
    explore_products: "SHOP NEW COLLECTION",
  ...
  ar: {
    ...
    embrace_elegance: "مجموعة الأزياء المحتشمة المفضلة في المملكة العربية السعودية 🇸🇦",
    hero_description: "أطقم تيرنو فاخرة، عبايات وملابس يومية مريحة",
    hero_bullet_1: "🔥 خصم يصل إلى 40%",
    hero_bullet_2: "🚚 الدفع عند الاستلام متوفر",
    hero_bullet_3: "⭐ أكثر من 1000+ عميل سعيد",
    ...
    explore_products: "تسوق المجموعة الجديدة",
  ...
  fil: {
    ...
    embrace_elegance: "Ang Paboritong Koleksyon ng Disenteng Kasuotan sa Saudi Arabia 🇸🇦",
    hero_description: "Premium Terno Sets, Abayas at Pang-araw-araw na Kasuotan",
    hero_bullet_1: "🔥 Hanggang 40% OFF",
    hero_bullet_2: "🚚 Cash on Delivery Available",
    hero_bullet_3: "⭐ 1000+ Masayang Customer",
    ...
    explore_products: "BUMILI NG BAGONG KOLEKSYON",
