    ...
    <div className="fixed inset-0 z-50 overflow-hidden bg-black/60 backdrop-blur-xs flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col z-10 animate-slide-in-right">
        ...
        <div className="px-4 py-5 border-b border-neutral-100 flex items-center justify-between gap-2">
          ...
          <button
            onClick={onClose}
            className="w-12 h-12 flex items-center justify-center rounded-full hover:bg-neutral-100 transition text-neutral-400 hover:text-black shrink-0"
            title="Close"
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <div className="flex items-center gap-1 border border-neutral-200 rounded-md overflow-hidden bg-white">
                      <button
                        ...
                        className="relative w-7 h-7 flex items-center justify-center hover:bg-neutral-50 transition text-neutral-500 after:absolute after:inset-[-10px] after:content-[''] after:cursor-pointer"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="w-12 h-12 flex items-center justify-center text-neutral-400 hover:text-red-500 hover:bg-red-50 rounded-full transition shrink-0"
                        title="Delete Item"
